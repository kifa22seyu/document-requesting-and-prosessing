...
const UpdateAccount = ({ existingAccount, onUpdate }) => {
  const [formData, setFormData] = useState({
    fullName: "",
    role: "Finance", // Default value
    email: "",
    password: "",
  });
  ...
  const handleSubmit = (e) => {
    ...
    // Simulate updating the account (you can replace this with an API call)
  ...
  return (
    <div className="max-w-md mx-auto mt-10 bg-white p-6 rounded-lg shadow-md">
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Update Account</h2>
