...
const Footer = () => {
  return (
    <footer className="w-full text-gray-700 bg-gradient-to-r from-blue-900 via-blue-700 to-blue-500 body-font">
      <div className="container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
        <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
          ...
          <p className="mt-2 text-sm text-gray-300">Design, Code and Ship!</p>
          <div className="mt-4">
        ...
        <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
          ...
          <div className="w-full px-4 lg:w-1/4 md:w-1/2">
            ...
            <nav className="mb-10 list-none">
              <li className="mt-3">
                <a className="text-gray-300 cursor-pointer hover:text-white">Contact Support</a>
              </li>
              <li className="mt-3">
                <a className="text-gray-300 cursor-pointer hover:text-white">Help Resources</a>
              </li>
              <li className="mt-3">
                <a className="text-gray-300 cursor-pointer hover:text-white">Release Updates</a>
              </li>
            </nav>
          </div>
          <div className="w-full px-4 lg:w-1/4 md:w-1/2">
          ...
          <div className="w-full px-4 lg:w-1/4 md:w-1/2">
            ...
            <nav className="mb-10 list-none">
              <li className="mt-3">
                <a className="text-gray-300 cursor-pointer hover:text-white">Send a Message</a>
              </li>
              <li className="mt-3">
                <a className="text-gray-300 cursor-pointer hover:text-white">Request a Quote</a>
              </li>
              <li className="mt-3">
                <a className="text-gray-300 cursor-pointer hover:text-white">+123-456-7890</a>
              </li>
            </nav>
          </div>
        </div>
      ...
      <div className="bg-blue-800">
        <div className="container px-5 py-4 mx-auto">
          <p className="text-sm text-gray-300 capitalize xl:text-center">© 2020 All rights reserved </p>
        </div>
      </div>
    </footer>
  );
